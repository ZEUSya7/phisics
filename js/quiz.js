// вопросы (пример, можно расширять)
const allQuestions = [
  {
  ...
  },
  {
    ...
    options: ["250м", "300м", "510м", "1км"],
    answer: 2
  },
  {
    question: "Виберіть, яка система відліку є інерціальною, а яка — неінерціальною для пасажира відносно автомобіля: 1. Автомобіль рухається прямолінійно і рівномірно по дорозі. 2. Автомобіль різко гальмує на дорозі.",
    options: [
...
nextBtn.addEventListener("click", () => {
  ...
  if (selectedAnswerIndex === currentQ.answer) score++;
